...
def append_data(results_dict, condition_to_predict, model, accuracy, y_true, y_pred, FP, FN):
    results_dict[condition_to_predict] = {
...
def save_data(results_dict, condition_to_predict, output_path):
    pickle_file_name = output_path + "_" + condition_to_predict + "_gains.pkl"
...
def main(condition_to_predict):
    ...
    plot_distributions(X, FN, features, condition_to_predict, output_path + "false_negatives_")
